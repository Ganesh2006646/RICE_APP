                ...
                return pw.Container(
                  ...
                  child: pw.Row(
                    children: [
                      ...
                      pw.Expanded(flex: 2, child: pw.Text(nf.format(item.ratePerQtl), textAlign: pw.TextAlign.right)),
                      pw.Expanded(flex: 3, child: pw.Text(nf.format(item.netAmount), textAlign: pw.TextAlign.right, style: pw.TextStyle(fontWeight: pw.FontWeight.bold))),
                    ],
                  ),
                );
              }).toList(),
              ...
              pw.Container(
                ...
                child: pw.Row(
                  ...
                  children: [
                    ...
                    pw.Expanded(flex: 3, child: pw.Text(nf.format(totalAmt), textAlign: pw.TextAlign.right, style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 16, color: PdfColors.blue900))),
                  ],
                ),
              ),
